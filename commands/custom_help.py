...
class CustomHelp(commands.Cog):
    ...
    @help.command(aliases="basement boss items spirit tips".split(" "))
    async def _guides_(self, ctx):
        titles = {
            ...
            'spirit': f'Shows spirit war guide',
        ...
        if message == 'basement':
            ...
            em.add_field(name="Commands List",
                         value="`fisw` `sosw` `wasw` `wisw`",
                         inline=False)
            em.add_field(name="How To Use", value=f"{ctx.prefix}guide <command>")
        elif message == 'tips':
            em.add_field(name="Commands List",
                         value="`armor` `aw` `newbie` `stats` `weapon`",
                         inline=False)
            em.add_field(name="How To Use", value=f"{ctx.prefix}guide <command>")
        await ctx.send(embed=em)
